...
DefaultTestFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services", "factory", "test", "default", "1.0");
DefaultTestFactory.ShutdownDescriptor = new pip_services_commons_node_1.Descriptor("pip-services", "shutdown", "*", "*", "1.0");
